            ...
            <div class="table-filter-div" id="product-filter">
                <form class="p-4 sm:p-5 mb-5" @submit.prevent="search">
                    <div class="row">
                        ...
                        <div class="col-12 sm:col-6 md:col-4 xl:col-3">
                            <label for="searchFileAttachment" class="db-field-title after:hidden">
                                {{ $t("label.file_attachment") }}
                            </label>
                            <vue-select class="db-field-control f-b-custom-select" id="searchFileAttachment"
                                v-model="props.search.file_attachment" :options="[
                                    { id: enums.activityEnum.ENABLE, name: $t('label.enable') },
                                    { id: enums.activityEnum.DISABLE, name: $t('label.disable') },
                                ]" label-by="name" value-by="id" :closeOnSelect="true" :searchable="true" :clearOnClose="true" placeholder="--"
                                search-placeholder="--" />
...
export default {
    ...
    methods: {
        ...
        clear: function () {
            ...
            this.props.search.file_attachment = null;
        ...
        edit: function (product) {
            ...
            this.props.form.file_attachment = product.file_attachment;
