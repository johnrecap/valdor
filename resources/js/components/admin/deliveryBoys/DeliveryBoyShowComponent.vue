                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-12 sm:col-6 !py-1.5">
                            <div class="db-list-item p-0">
                                ...
                                <span v-if="deliveryBoy.phone" class="db-list-item-text w-full sm:w-1/2">{{
                                    deliveryBoy.country_code + '' + deliveryBoy.phone
                                    }}</span>
                                <span v-else class="db-list-item-text w-full sm:w-1/2">{{ $t("label.n/a") }}</span>
                            </div>
                        </div>
                        <div class="col-12 sm:col-6 !py-1.5">
                            <div class="db-list-item p-0">
                                <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.delivery_zone') }}</span>
                                <span class="db-list-item-text w-full sm:w-1/2">{{ deliveryBoy.delivery_zone_name
                                }}</span>
                            </div>
                        </div>
                        <div class="col-12 sm:col-6 !py-1.5">
