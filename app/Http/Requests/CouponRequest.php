...
class CouponRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if(!$this->isPercentage() && request('maximum_discount') < request('discount')) {
                $validator->errors()->add('discount', 'Discount can\'t be greater than maximum discount');
            }
            
            if(!$this->isPercentage() && request('maximum_discount') > request('minimum_order')) {
                $validator->errors()->add('minimum_order', 'Minimum order can\'t be smaller than maximum discount.');
            }
        });
    }
