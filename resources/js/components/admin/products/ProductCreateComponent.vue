            ...
            <div class="drawer-body">
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            <label class="db-field-title required" for="attachmentenable">{{ $t("label.file_attachment")
                                }}</label>
                            <div class="db-field-radio-group">
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input type="radio" v-model="props.form.file_attachment" id="attachmentenable"
                                            :value="enums.activityEnum.ENABLE" class="custom-radio-field">
                                        <span class="custom-radio-span"></span>
                                    </div>
                                    <label for="attachmentenable" class="db-field-label">{{ $t('label.enable')
                                        }}</label>
                                </div>
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input type="radio" class="custom-radio-field"
                                            v-model="props.form.file_attachment" id="attachmentdisable"
                                            :value="enums.activityEnum.DISABLE">
                                        <span class="custom-radio-span"></span>
                                    </div>
                                    <label for="attachmentdisable" class="db-field-label">{{ $t('label.disable')
                                        }}</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            <label class="db-field-title required" for="sellAsFractionYes">{{
                                $t("label.sell_by_fraction")
                            }} </label>
                            <div class="db-field-radio-group">
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                ...
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input type="radio" class="custom-radio-field"
                                            v-model="props.form.sell_by_fraction" id="sellAsFractionNo"
    ...
    methods: {
        ...
        reset: function () {
            ...
            this.$props.props.form = {
                ...
                file_attachment: activityEnum.DISABLE,
